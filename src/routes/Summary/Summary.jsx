...
import { collection, where, getDocs, query, getAuth, signInAnonymously } from 'firebase/auth';
...
export default function Summary() {
  ...
  useEffect(() => {
    const getSecretSanta = async () => {
      ...
      console.log(
        querySnapshot.docs[0].data()?.participants?.filter((obj) => obj.isProfilCompleted === true)
      );
      setReady(
        querySnapshot.docs[0].data()?.participants?.filter((obj) => obj.isProfilCompleted === true)
      );
    ...
    <>
      {loader ? (
        ...
        <div className="summary">
          ...
          />
          <HeaderSummary eventDate={secretSanta.eventDate} name={secretSanta.eventName} />
